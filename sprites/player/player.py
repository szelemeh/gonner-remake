...
class Player(Actor):
    ...
    def fire(self):
        if self.weapon is not None:
            self.weapon.fire_from_at_direction(self.rect.x, self.rect.y + 47,
    ...
    def update(self):
        ...
        block_hit_list = pg.sprite.spritecollide(self, self.collide_list,
                                                 False)
    ...
    def jump(self):
        ...
        self.rect.y += 2
        platform_hit_list = pg.sprite.spritecollide(self, self.collide_list,
                                                    False)
        self.rect.y -= 2
