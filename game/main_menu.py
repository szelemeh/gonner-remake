...
class MainMenu:
    ...
    def show(self):
        ...
        self.drawer.draw_text('Play - press 1', 48, WHITE, WIDTH / 2,
                              3 * HEIGHT / 10)
        self.drawer.draw_text('Tutorial - press 2', 48, WHITE, WIDTH / 2,
                              4 * HEIGHT / 10)
        self.drawer.draw_text('Quit - press 3', 48, WHITE, WIDTH / 2,
                              5 * HEIGHT / 10)
        pg.display.flip()
